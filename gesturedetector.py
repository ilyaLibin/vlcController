...
class GestureDetector:
    ...
    def detect(self, thresh, cnt):
        # compute the convex hull of the contour and then find the most extreme points along
        # the hull
        ...
        # in the frame
        (_, cnts, _) = cv2.findContours(circleROI.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
        total = 0
        ...
        for c in cnts:
            ...
            # contour does not exceed 25% of the circumference and (2) the contour region is not
